...
\begin{itemize}
	...
	\item \textbf{Receiver}: duty of receiving a packet from the channel. Parameters: Response Time Signal
\end{itemize}
...
\begin{enumerate}
	\item The \textit{Receiver} wakes up when a packet arrives. Then are computed some statistics (concerning Response Time).
\end{enumerate}